    ...
    public class SpacesEstimatorTests
    {
        ...
        public void OneDayWithSpaces()
        {
            ...
            while (schedule.NotUsedMeetings.Count != 0)
            {
                ...
                Assert.GreaterOrEqual(0, studentEstimator.EstimateMeetingToAdd(schedule, meeting));
                Assert.GreaterOrEqual(0, teacherEstimator.EstimateMeetingToAdd(schedule, meeting));
