...
namespace Testing.RuleTests
{
    ...
    {
        private static LearningPlanItem standartLearningPlanItem = new LearningPlanItem(
            "FT-202", new Discipline("OOP"), MeetingType.Lecture, GroupSize.HalfGroup, 2);
        private static Requisition standartRequestion = new Requisition(
            ...
            new Teacher("Eg"),
            WeekType.Any);
        private static Schedule standartSchedule = new Schedule(new[] {
        ...
        private static LearningPlan standartLearningPlan = new LearningPlan(
            new[]{
        ...
        public void EvaluateWhenNoPracticesInPlan()
        {
            ...
            var actualPenalty = lecturerHasPracticeWithSameFlowRule.Evaluate(learningPlan, standartRequestion, testSchedule, meetingToAdd);
        ...
        public void EvaluateCorrect()
        {
            ...
            var lecturerHasPracticeWithSameFlowRule = new LecturerHasPracticeWithSameFlow();
            var actualPenalty = lecturerHasPracticeWithSameFlowRule.Evaluate(standartLearningPlan, standartRequestion, standartSchedule, meetingToAdd);
            Assert.AreEqual(0, actualPenalty);
        }
