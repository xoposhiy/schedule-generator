...
namespace Domain.Algorithms
{
    public class GreedyScheduleGenerator : IScheduleGenerator
    {
        public Schedule MakeSchedule(LearningPlan learningPlan, MeetingEvaluator evaluator, Requisition requisition)
        {
            ...
            // var meetingsToFill = requisition.Items
            //     .Select(Conversions.RequisitionToMeetingConverter.ConvertRequisitionToBasicMeeting)
            //     .SelectMany(x=>x)
            //     .ToArray();
            ...
            //     Console.WriteLine($"{tryingResult.Item1.Meetings.Length} {tryingResult.Item2} {bestPenalty}");
